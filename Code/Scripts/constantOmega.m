...
core_401.PETM.d11bco2.carbonate_chemistry.assignToEach("saturation_state",saturation_state_sampler.samples); %use same omega
...
core_1209.PETM.d11bco2.carbonate_chemistry.assignToEach("saturation_state",saturation_state_sampler.samples); %use same omega
...
save('petmCSOmega.mat','-struct','output');
