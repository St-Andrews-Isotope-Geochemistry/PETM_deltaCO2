...
AlkInc = 300./1e6; %prescribed increased in Alk during the PETM according to Gutjahr et al., 2017
%% Make samplers
...
core_401.PETM.d11bco2.carbonate_chemistry.assignToEach("alkalinity",core_401.prePETM.d11bco2.carbonate_chemistry.alkalinity+AlkInc); % use prePETM then increase
...
core_1209.PETM.d11bco2.carbonate_chemistry.assignToEach("alkalinity",core_1209.prePETM.d11bco2.carbonate_chemistry.alkalinity+AlkInc); % Use PETM then increase
